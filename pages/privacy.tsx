export default function Privacy() {
  return (
    <div style={{ padding: 8 }}>
      ...
      <p>
        Adeola Ade built the Sator app as a free app (subject to change). This
        SERVICE is provided by Adeola Ade at no cost (subject to change) and is
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Sator unless otherwise
      ...
      <p>
        ...
        but not limited to The excellent app. The information that I request
      ...
      <p>
        ...
        <a href="mailto:adedotster@gmail.com">email</a>.
      </p>
      <p>
